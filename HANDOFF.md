...
## Where things are, 3 Sep 2026

All live on GitHub Pages from this repo.

- Prototype, current: https://ritwik-turing.github.io/humain-one/Eval_Journey_V16.html (file Eval_Journey_V16.html). V16 makes failure-note automation and human control explicit: Prism drafts default notes from run evidence, the developer accepts or edits them before grouping, and evidence-insufficient cases rise first as high priority. It retains V15's Snowflake lifecycle, metric provenance, immutable job receipts, and complete improvement loop.
