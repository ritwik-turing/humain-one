...
setTimeout(async()=>{
  ...
  test('Add quality check opens the library in context',()=>{w.document.querySelector('#qualityStartState [data-quality-view="library"]').click();return !w.document.getElementById('qualityCheckPicker').hidden&&!w.document.getElementById('qualityLibraryPane').hidden&&w.document.getElementById('qualityCreatePane').hidden;});
