...
2. Open the current prototype and click through all nine screens: [Eval_Journey_V11.html](file:///Users/ritwikmac/Documents/GitHub/humain-one/Eval_Journey_V11.html) , live at https://ritwik-turing.github.io/humain-one/Eval_Journey_V11.html
...
6. Before you change anything, run the self test so you know the baseline is green: `bash "/Users/ritwikmac/Documents/GitHub/humain-one/tools/selftest.sh" "/Users/ritwikmac/Documents/GitHub/humain-one/Eval_Journey_V11.html"`
...
|---|---|---|
| [Eval_Journey_V11.html](file:///Users/ritwikmac/Documents/GitHub/humain-one/Eval_Journey_V11.html) | CURRENT prototype. Preserves V10's agent-specific Prism metric model and adds immutable run receipts, definition/runtime provenance, and metric-version-safe comparisons across results, evidence, and verification. | [https://ritwik-turing.github.io/humain-one/Eval_Journey_V11.html](https://ritwik-turing.github.io/humain-one/Eval_Journey_V11.html) |
...
> You are taking over the Humain ONE eval workstream from a previous assistant. Read the takeover document in full before doing anything: [Eval workstream - takeover handoff.md](file:///Users/ritwikmac/Documents/Claude/Projects/Humain%20AI%20agent%20marketplace%20project%20by%20Turing/Eval%20workstream%20-%20takeover%20handoff.md) (also at https://github.com/ritwik-turing/humain-one/blob/main/TAKEOVER.md). Follow its working rules exactly, especially the completion gate, the delivery rule, and the writing rules. The current prototype is V11; never edit a version that has been sent, copy to the next number. When I give you a task, produce the deliverable with full local and live links, and the ledger of what you built against what was asked. Confirm you have read it by telling me, in one line each, why Prism metrics are not a universal scorecard, what coverage means, why immutable run receipts matter, and why there is no pass mark.
