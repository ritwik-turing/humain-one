...
2. Open the current prototype and click through all nine screens: [Eval_Journey_V10.html](file:///Users/ritwikmac/Documents/GitHub/humain-one/Eval_Journey_V10.html) , live at https://ritwik-turing.github.io/humain-one/Eval_Journey_V10.html
...
4. Read the coverage ledger, which is the Prism demo checked item by item against V10: [PRISM_DEMO_COVERAGE.md](file:///Users/ritwikmac/Documents/GitHub/humain-one/PRISM_DEMO_COVERAGE.md)
...
6. Before you change anything, run the self test so you know the baseline is green: `bash "/Users/ritwikmac/Documents/GitHub/humain-one/tools/selftest.sh" "/Users/ritwikmac/Documents/GitHub/humain-one/Eval_Journey_V10.html"`
...
|---|---|---|
| [Eval_Journey_V10.html](file:///Users/ritwikmac/Documents/GitHub/humain-one/Eval_Journey_V10.html) | CURRENT prototype. Metrics are agent-specific authored definitions; a new evaluation starts with 0 attached; Prompt, Deterministic, REST API and Agentic are all represented; Humain ONE platform observations are separate from Prism metric aggregates. | [https://ritwik-turing.github.io/humain-one/Eval_Journey_V10.html](https://ritwik-turing.github.io/humain-one/Eval_Journey_V10.html) |
...
> You are taking over the Humain ONE eval workstream from a previous assistant. Read the takeover document in full before doing anything: [Eval workstream - takeover handoff.md](file:///Users/ritwikmac/Documents/Claude/Projects/Humain%20AI%20agent%20marketplace%20project%20by%20Turing/Eval%20workstream%20-%20takeover%20handoff.md) (also at https://github.com/ritwik-turing/humain-one/blob/main/TAKEOVER.md). Follow its working rules exactly, especially the completion gate, the delivery rule, and the writing rules. The current prototype is V10; never edit a version that has been sent, copy to the next number. When I give you a task, produce the deliverable with full local and live links, and the ledger of what you built against what was asked. Confirm you have read it by telling me, in one line each, why Prism metrics are not a universal scorecard, what coverage means, and why there is no pass mark.
