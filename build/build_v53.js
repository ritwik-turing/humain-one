...
const OUT = path.join(REPO, 'Agent_Lifecycle_V53.html');
const ENGINE = 'Eval_Journey_V103.html';
...
// ---- V53: Submit Agent flow is the Invoice Processing Agent end to end ----
...
// ---------------- shell ----------------
H = rep(H, '<title>HUMAIN ONE — Agent Lifecycle V13</title>', '<title>HUMAIN ONE — Agent Lifecycle V53</title>', 1, 'title');
...
window.__evalHub=(function(){
  var ENGINE='${ENGINE}',KEYS=['eval_journey_v103:final','eval_journey_v102:final'];
