...
const OUT = path.join(REPO, 'Agent_Lifecycle_V54.html');
...
// ---- V54: Submit Agent flow is the Invoice Processing Agent end to end ----
...
// ---------------- shell ----------------
H = rep(H, '<title>HUMAIN ONE — Agent Lifecycle V13</title>', '<title>HUMAIN ONE — Agent Lifecycle V54</title>', 1, 'title');
