...
const OUT = path.join(REPO, 'Agent_Lifecycle_V47.html');
const ENGINE = 'Eval_Journey_V97.html';
...
// ---- V47: Submit Agent flow is the Invoice Processing Agent end to end ----
...
// ---------------- shell ----------------
H = rep(H, '<title>HUMAIN ONE — Agent Lifecycle V13</title>', '<title>HUMAIN ONE — Agent Lifecycle V47</title>', 1, 'title');
...
window.__evalHub=(function(){
  var ENGINE='${ENGINE}',KEYS=['eval_journey_v97:final','eval_journey_v96:final'];
