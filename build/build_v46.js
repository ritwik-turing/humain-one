...
const OUT = path.join(REPO, 'Agent_Lifecycle_V46.html');
const ENGINE = 'Eval_Journey_V96.html';
...
// ---------------- shell ----------------
H = rep(H, '<title>HUMAIN ONE — Agent Lifecycle V13</title>', '<title>HUMAIN ONE — Agent Lifecycle V46</title>', 1, 'title');
...
window.__evalHub=(function(){
  var ENGINE='${ENGINE}',KEYS=['eval_journey_v96:final','eval_journey_v95:final'];
