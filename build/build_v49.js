...
const OUT = path.join(REPO, 'Agent_Lifecycle_V49.html');
const ENGINE = 'Eval_Journey_V99.html';
...
// ---- V49: Submit Agent flow is the Invoice Processing Agent end to end ----
...
// ---------------- shell ----------------
H = rep(H, '<title>HUMAIN ONE — Agent Lifecycle V13</title>', '<title>HUMAIN ONE — Agent Lifecycle V49</title>', 1, 'title');
...
window.__evalHub=(function(){
  var ENGINE='${ENGINE}',KEYS=['eval_journey_v99:final','eval_journey_v98:final'];
