...
const OUT = path.join(REPO, 'Agent_Lifecycle_V50.html');
const ENGINE = 'Eval_Journey_V100.html';
...
// ---- V50: Submit Agent flow is the Invoice Processing Agent end to end ----
...
// ---------------- shell ----------------
H = rep(H, '<title>HUMAIN ONE — Agent Lifecycle V13</title>', '<title>HUMAIN ONE — Agent Lifecycle V50</title>', 1, 'title');
...
window.__evalHub=(function(){
  var ENGINE='${ENGINE}',KEYS=['eval_journey_v100:final','eval_journey_v99:final'];
